    ...
    <div className={`flex absolute left-[252px] top-56 max-md:flex-wrap gap-4 max-md:gap-2 max-md:left-8 max-md:top-[180px] max-sm:overflow-x-auto max-sm:flex-nowrap max-sm:gap-1 max-sm:left-6 max-sm:top-[130px] ${className}`} role="tablist">
      {tabs.map((tab) => (
        <button
          ...
          className={`flex w-[248px] h-16 justify-center items-center gap-2 shadow-[0_3px_0_0_#FEF2CC] px-[68px] py-[22px] rounded-[20px_20px_0_0] border-2 border-solid border-[#FEF2CC] max-md:w-[calc(50%_-_4px)] max-md:h-12 max-md:px-6 max-md:py-4 max-sm:min-w-[120px] max-sm:h-10 max-sm:px-4 max-sm:py-3 transition-colors hover:bg-[#FEF9E5] ${
